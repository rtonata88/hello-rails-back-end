...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create greeting' do
    assert_difference('Greeting.count') do
      post greetings_url, params: { greeting: { greeting: @greeting.greeting, language: @greeting.language } }
    end
  ...
  test 'should update greeting' do
    patch greeting_url(@greeting), params: { greeting: { greeting: @greeting.greeting, language: @greeting.language } }
